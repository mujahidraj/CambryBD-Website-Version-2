...
async function main() {
    ...
    await prisma.counselor.createMany({
        data: [
            { name: "British Council Certified Counselor", role: "Certified Counselor", bio: "Recognized by the British Council for quality guidance and ethical counseling standards.", imageUrl: "https://i.postimg.cc/DyrWZMyx/cambry-logo.png", email: "info@cambrybd.com" },
            { name: "ABC Certified Counselor", role: "Certified Counselor", bio: "Certified under ABC standards for professional student advisory and admissions support.", imageUrl: "https://i.postimg.cc/DyrWZMyx/cambry-logo.png", email: "info@cambrybd.com" },
            { name: "NZQA Certified Counselor", role: "Certified Counselor", bio: "Trained to advise students based on New Zealand Qualifications Authority pathways and requirements.", imageUrl: "https://i.postimg.cc/DyrWZMyx/cambry-logo.png", email: "info@cambrybd.com" },
            { name: "ICEF Certified Counselor", role: "Certified Counselor", bio: "ICEF-certified for international education best practices, compliance, and student-first counseling.", imageUrl: "https://i.postimg.cc/DyrWZMyx/cambry-logo.png", email: "info@cambrybd.com" },
        ],
    });
    ...
    // ===== IELTS & PTE INFO =====
    console.log("🧪 Creating IELTS/PTE exam and course records...");
    await prisma.iELTSInfo.createMany({
        data: [
            {
                testProvider: "IELTS",
                offeringType: "EXAM",
                testType: "IELTS Academic Exam",
                moduleType: "Academic",
                ...
                seats: 40,
                requirements: "Passport copy, NID, recent photo, payment confirmation.",
                nextDate: new Date("2026-04-20"),
                registrationOpenUntil: new Date("2026-04-12"),
                ctaLabel: "Book IELTS Academic",
                ctaUrl: "/ielts-booking#enquiry",
                notes: "Morning and afternoon slots available.",
            ...
            },
            {
                testProvider: "IELTS",
                offeringType: "EXAM",
                testType: "IELTS General Training Exam",
                moduleType: "General Training",
                description: "For migration and work pathways in English-speaking countries.",
                fee: "BDT 22,500",
                venue: "IDP, Dhaka",
                duration: "2h 45m",
                classMode: "Offline",
                ...
                seats: 35,
                requirements: "Passport copy, NID, valid phone number, payment receipt.",
                nextDate: new Date("2026-04-27"),
                registrationOpenUntil: new Date("2026-04-18"),
                ctaLabel: "Book IELTS General",
                ctaUrl: "/ielts-booking#enquiry",
                notes: "Weekend exam slots available.",
            ...
            },
            {
                testProvider: "PTE",
                offeringType: "EXAM",
                testType: "PTE Academic Exam",
                moduleType: "Academic",
                description: "Computer-based English test accepted by universities and immigration bodies.",
                fee: "USD 220",
                venue: "Pearson Test Center, Dhaka",
                duration: "2 hours",
                classMode: "Offline",
                targetScore: "PTE 65+",
                seats: 30,
                requirements: "Valid passport, Pearson account, payment proof.",
                nextDate: new Date("2026-04-24"),
                registrationOpenUntil: new Date("2026-04-16"),
                ctaLabel: "Book PTE Exam",
                ctaUrl: "/ielts-booking#enquiry",
                notes: "Score report generally available within 48 hours.",
            ...
            },
            {
                testProvider: "IELTS",
                offeringType: "COURSE",
                testType: "IELTS Preparation Course",
                moduleType: "Regular Batch",
                description: "Comprehensive IELTS coaching with module-wise strategy and weekly mock tests.",
                fee: "BDT 12,000",
                venue: "Cambry Training Center, Dhaka",
                duration: "8 weeks",
                classMode: "Hybrid",
                targetScore: "IELTS 7+",
                seats: 25,
                requirements: "Initial diagnostic test and registration form.",
                nextDate: new Date("2026-04-15"),
                registrationOpenUntil: new Date("2026-04-10"),
                ctaLabel: "Enroll IELTS Course",
                ctaUrl: "/ielts-booking#enquiry",
                notes: "Includes 6 full-length mocks and speaking workshops.",
            ...
            },
            {
                testProvider: "PTE",
                offeringType: "COURSE",
                testType: "PTE Preparation Course",
                moduleType: "Fast Track",
                description: "PTE-focused coaching with AI-scored practice and intensive speaking drills.",
                fee: "BDT 14,000",
                venue: "Cambry Training Center, Dhaka",
                duration: "6 weeks",
                classMode: "Online",
                targetScore: "PTE 65+",
                seats: 20,
                requirements: "Registration form and baseline mock test.",
                nextDate: new Date("2026-04-18"),
                registrationOpenUntil: new Date("2026-04-13"),
                ctaLabel: "Enroll PTE Course",
                ctaUrl: "/ielts-booking#enquiry",
                notes: "Daily practice tasks and mentor feedback included.",
